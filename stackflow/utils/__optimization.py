...
from stackflow.models.hoi_instances_prior import HOIInstance
...
def post_optimization(cfg, dataset_metadata, model, batch, predictions):
    ...
    hoi_instance = HOIInstance(smpl=smpl, 
                               ...
                               hoi_trans=predictions['hoi_trans'].detach(), ).to(device)
    optimizer = hoi_instance.get_optimizer(lr=cfg.eval.optim_lr)
